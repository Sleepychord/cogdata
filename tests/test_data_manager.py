...
def test_data_manager():
    if os.path.exists('./smalltest'):
        shutil.rmtree('./smalltest')
    os.makedirs('./smalltest')
    os.chdir('./smalltest')
    ...
    shutil.copyfile('../downloads/testcase.tar', 'd0/testcase.tar')
    shutil.copyfile('../downloads/testcase.json', 'd0/testcase.json')

    args.name = 'd1'
    args.description = 'd1'
    DataManager.new_dataset(args)
    shutil.copyfile('../downloads/testcase.tar', 'd1/testcase.tar')
    shutil.copyfile('../downloads/testcase.json', 'd1/testcase.json')
