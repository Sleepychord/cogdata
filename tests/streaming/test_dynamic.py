...
from cogdata.streaming.processfns import ImageTextPairProcessFnBuilder

def test_load_imgs(conf_path='tests/streaming/img_txt_testcase_dynamic.yaml'):
    dataset = instantiate_from_yaml(conf_path, dynamic_objs={
        'txt_builder': ImageTextPairProcessFnBuilder(
            img_size=224,
            max_text_len=256,
